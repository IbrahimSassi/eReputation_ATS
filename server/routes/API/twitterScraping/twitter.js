/**
 * Created by MrFirases on 3/15/2017.
 */
...
// **** VALIDATION **************************************************************************************************************** //
  ...
  router.get('/search',function (req,res) {
    ...
    if (req.query.Language !=null && req.query.Until !=null && req.query.Number !=null
      && req.query.Keywords !=null)
    {

      client.get('search/tweets', {q: req.query.Keywords + " " + "until:"+req.query.Until+" lang:"
      +req.query.Language+" ",
        count: req.query.Number }, function(error, tweets, response) {
        res.json(tweets)
      });
    }
...
router.get('/streamtweets',function (req,res) {

  var Tunisia = [ '7.52448164229', '30.3075560572', '11.4887874691', '37.3499944118' ]
  var sanFrancisco = [ '-122.75', '36.8', '-121.75', '37.8' ]


  var stream = twitter.stream('statuses/filter', {track: ['NBA', 'Basketball', 'Jordan'], locations: sanFrancisco})
