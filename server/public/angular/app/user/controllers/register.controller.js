...
if ((vm.credentialsRegister.username.length <5 && vm.credentialsRegister.businessName.length <5) || (vm.credentialsRegister.password != vm.credentialsRegister.passwordAgain)
)
{
}
