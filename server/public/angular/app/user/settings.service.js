...
(function () {
  ...
  function SettingsService($http,$window,SettingsFactory) {
    ...
    var EditBasicInformationIndividual = function(userToEdit) {
      ...
      return SettingsFactory.basicinformationIndiv({activeEmail:userToEdit.activeEmail,email:userToEdit.email,
        firstName:userToEdit.firstName,lastName:userToEdit.lastName,username:userToEdit.username,phoneNumber:userToEdit.phoneNumber}).$promise;
    };

    var EditBasicInformationBusiness = function(userToEdit) {
      //return $http.post('/users/register', user)
      return SettingsFactory.basicinformationBuss({activeEmail:userToEdit.activeEmail,email:userToEdit.email,
      businessName:userToEdit.businessName,businessType:userToEdit.businessType,employeesNumber:userToEdit.employeesNumber,phoneNumber:userToEdit.phoneNumber}).$promise;
    };

    var EditAdditionalInformation = function(userToEdit) {
      //return $http.post('/users/register', user)
      return SettingsFactory.additionalInformation({activeEmail:userToEdit.activeEmail,profilePicture:userToEdit.profilePicture,
