  ...
  angular
    ...
    .directive("lineChart", function () {
      return {
        ...
        templateUrl: 'angular/app/components/charts/lineChart/radarchart.template.html',
        link: function (scope, elem, attrs) {

          console.log(JSON.parse(scope.labels))
          ...
          setTimeout(function () {
            ...
            var FacebookFansLineChart = document.getElementById("line-chart-component").getContext("2d");
